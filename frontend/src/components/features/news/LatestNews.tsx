  ...
  const newsItems: NewsItem[] = [
    {
      ...
      excerpt: "Join us for the biggest alumni gathering of the year, featuring keynote speakers, networking sessions, and career opportunities.",
    ...
    },
    {
      ...
      excerpt: "We're proud to announce our new scholarship program supporting aspiring electrical engineering students from underprivileged backgrounds.",
    ...
    },
    {
      ...
      excerpt: "Meet Sarah Wijaya, Class of 2018, who's making waves in the renewable energy sector with her groundbreaking solar panel technology.",
