...
export function LeadershipTeam({ className = '' }: LeadershipTeamProps) {
  const leadershipMembers: LeadershipMember[] = [
    ...
    },
    {
      ...
      photo: '/images/leadership/vice-chairman.jpg',
    ...
    },
    {
      ...
      photo: '/images/leadership/treasurer.jpg',
    ...
    },
    {
      ...
      photo: '/images/leadership/alumni-relations.jpg',
    ...
    },
    {
      ...
      photo: '/images/leadership/programs.jpg',
